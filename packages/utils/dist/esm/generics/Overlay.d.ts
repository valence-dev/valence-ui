...
export type GenericOverlayBackgroundProps = GenericProps & PolymorphicLayoutProps & {
...
export type GenericOverlayProps = GenericLayoutProps & PolymorphicLayoutProps & {
    /** The title of this overlay */
    title: string;
