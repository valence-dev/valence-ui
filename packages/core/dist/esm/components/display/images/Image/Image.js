...
export const Image = forwardRef(function Image(props, ref) {
    ...
    // Defaults
    const _a = useResponsiveProps(props), { src, alt, placeholder = (_jsx(Flex, { align: "center", justify: "center", height: "100%", width: "100%", children: _jsx(Icon, { children: _jsx(IconPhoto, {}) }) })), radius = theme.defaults.radius, fit = "cover", position = "center", square = false, height = "fit-content", width = square ? height : "auto", shadow = false, style } = _a, rest = __rest(_a, ["src", "alt", "placeholder", "radius", "fit", "position", "square", "height", "width", "shadow", "style"]);
    // Styles
