...
import { useResponsiveProp, useResponsiveProps } from "../../../responsive";
export const OutlineContainer = forwardRef(function OutlineContainer(props, ref) {
    ...
    const OutlineContainerStyle = Object.assign({ backgroundColor: theme.getColorHex("white", "strong"), backdropFilter: "blur(5px)", outlineColor: theme.getColorHex(color, "medium"), outlineWidth: 1, outlineStyle: "solid", padding: spacing, borderRadius: theme.sizeClasses.radius[radius] + spacing }, style);
