...
export function InputContainer(props) {
    ...
    return (_jsxs(StyledInputContainer, Object.assign({}, rest, { children: [required && _jsx(StyledRequireIndicator, {}), (icon || loading) &&
                _jsx(StyledIconContainer, { children: loading ? _jsx(Loader, {}) : icon }), children] })));
}
