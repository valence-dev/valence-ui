...
export const ModalBackground = forwardRef(function ModalBackground(props, ref) {
    ...
    // Defaults
    const { disclosure, closeOnClick = true, backdropFilter = "blur", backgroundColor = "permaBlack", padding = theme.sizeClasses.padding[theme.defaultSize], zIndex = 500, children, style } = props, rest = __rest(props, ["disclosure", "closeOnClick", "backdropFilter", "backgroundColor", "padding", "zIndex", "children", "style"]);
    // Styles
