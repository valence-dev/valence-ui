...
export const ModalOverlay = forwardRef(function ModalOverlay(props, ref) {
    ...
    return (_jsx(motion.div, Object.assign({ css: OverlayStyle, onClick: closeOnClick ? close : undefined, initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, ref: ref }, rest, { children: children })));
});
