...
import { DialogOverlay, Disclosure } from "../../..";
...
export type DialogProps = GenericLayoutProps & PolymorphicLayoutProps & {
    ...
    overlayProps?: DialogOverlay;
    /** Optional props to pass to the flex component */
    flexProps?: FlexProps;
    /** Optional props to pass to the close button */
    closeButtonProps?: IconButtonProps;
};
export declare const Dialog: import("react").ForwardRefExoticComponent<import("@valence-ui/utils").GenericProps & {
    ...
    /** Optional props to pass to the overlay component */
    overlayProps?: DialogOverlay | undefined;
    /** Optional props to pass to the flex component */
