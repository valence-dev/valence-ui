 ...
 */
export declare function useDetectKeyDown(callback: (e: KeyboardEvent) => void, keys: string | string[], runCheck?: boolean, deps?: any[]): void;
//# sourceMappingURL=UseDetectKeyDown.d.ts.map