...
exports.useScrollManager = void 0;
const react_1 = require("react");
function useScrollManager(parentRef, childRef, callbacks, allowDrag = true, direction = "x") {
    // Native scroll
    const [scrollManager, setScrollManager] = (0, react_1.useState)({
        scrolling: false,
        isAtStart: true,
        isAtEnd: false,
        nearestChild: 0,
    ...
    const [mouseCoords, setMouseCoords] = (0, react_1.useState)({ startDistance: 0, scrollDistance: 0 });
...
exports.useScrollManager = useScrollManager;
