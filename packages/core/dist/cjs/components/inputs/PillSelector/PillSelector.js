...
exports.PillSelector = (0, react_2.forwardRef)(function PillSelector(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(layout_1.Flex, Object.assign({ direction: "column", gap: gap, style: ContainerStyle, ref: ref }, rest, { children: [allowEditing &&
                (0, jsx_runtime_1.jsxs)(layout_1.Flex, { width: "100%", gap: gap, children: [(0, jsx_runtime_1.jsx)(TextInput_1.TextInput, Object.assign({ value: inputValue, setValue: setInputValue, onEnterPress: () => addPill(), placeholder: placeholder, variant: variant, size: size, radius: radius, color: color, backgroundColor: backgroundColor, loading: loading, disabled: disabled, readOnly: readOnly, required: required }, inputProps)), (0, jsx_runtime_1.jsx)(buttons_1.IconButton, Object.assign({ size: size, radius: radius, color: color, variant: "subtle", onClick: () => addPill() }, addButtonProps, { children: addButtonIcon }))] }), (0, jsx_runtime_1.jsxs)(layout_1.Flex, { gap: gap, width: "100%", height: "fit-content", align: "center", children: [(0, jsx_runtime_1.jsx)(layout_1.Flex, Object.assign({ gap: gap, css: PillContainerStyle }, pillContainerPropsRest, { children: pills.map((pill, index) => {
