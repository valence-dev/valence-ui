...
exports.Button = (0, react_1.forwardRef)(function Button(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(PrimitiveButton_1.PrimitiveButton, Object.assign({ size: size, variant: variant, color: color, ref: ref }, rest, { children: (0, jsx_runtime_1.jsx)(display_1.Text, Object.assign({ size: size, color: colors.getFgHex(color, variant) }, textProps, { children: children })) })));
});
