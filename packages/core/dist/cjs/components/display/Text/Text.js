...
exports.Text = (0, react_1.forwardRef)(function Text(props, ref) {
    ...
    replacements = (0, react_string_replace_1.default)(replacements, REGEX_PATTERNS.newline, (match, i) => ((0, jsx_runtime_1.jsx)("br", {}, randomId())));
    replacements = (0, react_string_replace_1.default)(replacements, REGEX_PATTERNS.boldItalic, (match, i) => ((0, jsx_runtime_1.jsx)("b", { style: {
            fontWeight: 800,
            fontStyle: "italic",
        }, children: (0, jsx_runtime_1.jsx)("i", { children: match }) }, randomId())));
    ...
    replacements = (0, react_string_replace_1.default)(replacements, /<hl>(.+?)<\/hl>/, (match, i) => ((0, jsx_runtime_1.jsx)("span", { style: Object.assign({ backgroundColor: colors.getHex(highlightColor, "weak"), color: colors.getHex(highlightColor), borderRadius: 5, padding: 2 }, highlightStyle), children: match }, randomId())));
    // Styles
