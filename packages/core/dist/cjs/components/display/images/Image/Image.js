...
exports.Image = (0, react_1.forwardRef)(function Image(props, ref) {
    ...
    // Defaults
    const _a = (0, responsive_1.useResponsiveProps)(props), { src, alt, placeholder, radius = theme.defaults.radius, fit = "cover", position = "center", square = false, height = "fit-content", width = square ? height : "auto", shadow = false, style } = _a, rest = __rest(_a, ["src", "alt", "placeholder", "radius", "fit", "position", "square", "height", "width", "shadow", "style"]);
    // Styles
