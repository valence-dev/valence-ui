...
exports.OutlineContainer = (0, react_1.forwardRef)(function OutlineContainer(props, ref) {
    ...
    // Defaults
    const _a = (0, responsive_1.useResponsiveProps)(props), { sticky = true, label, labelProps, spacing = 5, radius = theme.defaults.radius, position = sticky ? "sticky" : "relative", zIndex = sticky ? 151 : "unset", top = (0, responsive_1.useResponsiveProps)(sticky ? { default: spacing * 2, mobile: 75 } : "unset"), left = sticky ? spacing * 2 : "unset", right = sticky ? spacing * 2 : "unset", bottom, width = "100%", height, color = "black", children, style } = _a, rest = __rest(_a, ["sticky", "label", "labelProps", "spacing", "radius", "position", "zIndex", "top", "left", "right", "bottom", "width", "height", "color", "children", "style"]);
