...
const Item = (0, react_1.forwardRef)(function GridItem(props, ref) {
    ...
    // Styles
    const ItemStyle = (0, react_2.css)(Object.assign({ gridArea: (0, utils_1.getReactiveProp)(area, breakpoint), gridColumn: (0, utils_1.getReactiveProp)(column, breakpoint), gridColumnStart: (0, utils_1.getReactiveProp)(columnStart, breakpoint), gridColumnEnd: (0, utils_1.getReactiveProp)(columnEnd, breakpoint), gridRow: (0, utils_1.getReactiveProp)(row, breakpoint), gridRowStart: (0, utils_1.getReactiveProp)(rowStart, breakpoint), gridRowEnd: (0, utils_1.getReactiveProp)(rowEnd, breakpoint), justifySelf: (0, utils_1.getReactiveProp)(justify, breakpoint), alignSelf: (0, utils_1.getReactiveProp)(align, breakpoint), placeSelf: (0, utils_1.getReactiveProp)(place, breakpoint), order: (0, utils_1.getReactiveProp)(order, breakpoint), backgroundColor: theme.getColorHex((0, utils_1.getReactiveProp)(backgroundColor, breakpoint)), color: theme.getColorHex((0, utils_1.getReactiveProp)(color, breakpoint)), padding: (0, utils_1.getReactiveProp)(padding, breakpoint), margin: (0, utils_1.getReactiveProp)(margin, breakpoint), width: (0, utils_1.getReactiveProp)(width, breakpoint), height: (0, utils_1.getReactiveProp)(height, breakpoint) }, (0, utils_1.getReactiveProp)(style, breakpoint)));
