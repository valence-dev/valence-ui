...
exports.OverflowContainer = (0, react_2.forwardRef)(function OverflowContainer(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ css: OverflowContainerStyle }, rest, { children: (0, jsx_runtime_1.jsx)(Flex_1.Flex, Object.assign({ ref: ref, style: innerStyle, width: innerWidth, height: innerHeight, direction: innerDirection }, innerRest, { children: children })) })));
});
