...
exports.Modal = (0, react_1.forwardRef)(function Modal(props, ref) {
    ...
    const _c = innerFlexProps || {}, { style: innerFlexStyle } = _c, innerFlexPropsRest = __rest(_c, ["style"]);
    // Hooks
    ...
    const FlexStyle = Object.assign({ width: "100%", height: "100%", overflowY: "scroll" }, flexStyle);
