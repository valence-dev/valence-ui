...
const Content = (0, react_1.forwardRef)(function Content(props, propRef) {
    ...
    // Styles
    const FloatingStyle = (0, react_3.css)(Object.assign({ borderRadius: theme.sizeClasses.radius[(0, utils_1.getReactiveProp)(radius, breakpoint)], boxShadow: !withShadow ? undefined : theme.defaultShadow, animationName: "in", animationDuration: "0.1s", overflowY: "auto", "@keyframes in": {
            from: {
                opacity: 0,
            },
            to: {
