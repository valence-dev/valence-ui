...
export function useBreakpoint(): Breakpoint {
  ...
  const isTablet: boolean =
    width <= breakpoints.tabletWidth && width > breakpoints.mobileWidth;
  const isDefault: boolean =
    width <= breakpoints.desktopLargeWidth && width > breakpoints.tabletWidth;
  const isDesktopLarge: boolean =
    width <= breakpoints.tvWidth && width > breakpoints.desktopLargeWidth;
