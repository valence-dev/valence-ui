...
export const DynamicSheet = forwardRef(function DynamicSheet(props, ref) {
    // Defaults
    const { type = useResponsiveProps({ default: "standard", tablet: "overlay", mobile: "bottom" }), disclosure, title, sideSheetProps, bottomSheetProps, children } = useResponsiveProps(props);
