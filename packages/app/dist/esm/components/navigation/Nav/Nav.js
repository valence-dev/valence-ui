...
export function Nav(props) {
    ...
    return (_jsxs(Flex, Object.assign({ direction: { default: "column", mobile: "row" }, gap: props.gap, style: navStyle, justify: { default: "unset", mobile: "space-around" } }, rest, { children: [favicon && !breakpoint.isMobile &&
                _jsx(Flex, { align: "center", justify: "center", height: 100, children: _jsx(PrimitiveButton, Object.assign({ motion: { onHover: "grow", onTap: "shrink" }, square: true }, faviconProps, { children: _jsx("img", { src: favicon, alt: "favicon", style: faviconStyle }) })) }), buttons.map(b => _jsx(IconButton, { color: "white", variant: b.highlighted ? "light" : "subtle", radius: breakpoint.isMobile ? "xl" : undefined, square: !breakpoint.isMobile, grow: true, component: "link", children: b.children }, b.id)), !breakpoint.isMobile && _jsx(Space, { grow: true, height: "100%" }), bottomButtons && bottomButtons.map(b => _jsx(IconButton, { color: "white", variant: b.highlighted ? "light" : "subtle", radius: breakpoint.isMobile ? "xl" : undefined, square: !breakpoint.isMobile, grow: true, component: "link", children: b.children }, b.id))] })));
}
