...
export const Sidebar = forwardRef(function Sidebar(props, ref) {
    ...
    // Defaults 
    const { gap = theme.sizeClasses.padding[theme.defaults.size], mobileFabProps = {}, mobileFabIcon = _jsx(Icon, { color: "white", children: _jsx(IconMenu, {}) }), width = "100%", height = "100%", children, style } = props, rest = __rest(props, ["gap", "mobileFabProps", "mobileFabIcon", "width", "height", "children", "style"]);
    // Styles
