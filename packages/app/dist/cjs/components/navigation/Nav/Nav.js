...
function Nav(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(core_1.Flex, Object.assign({ direction: { default: "column", mobile: "row" }, gap: props.gap, style: navStyle, justify: { default: "unset", mobile: "space-around" } }, rest, { children: [favicon && !breakpoint.isMobile &&
                (0, jsx_runtime_1.jsx)(core_1.Flex, { align: "center", justify: "center", height: 100, children: (0, jsx_runtime_1.jsx)(core_1.PrimitiveButton, Object.assign({ motion: { onHover: "grow", onTap: "shrink" }, square: true }, faviconProps, { children: (0, jsx_runtime_1.jsx)("img", { src: favicon, alt: "favicon", style: faviconStyle }) })) }), buttons.map(b => (0, jsx_runtime_1.jsx)(core_1.IconButton, { color: "white", variant: b.highlighted ? "light" : "subtle", radius: breakpoint.isMobile ? "xl" : undefined, square: !breakpoint.isMobile, grow: true, component: "link", children: b.children }, b.id)), !breakpoint.isMobile && (0, jsx_runtime_1.jsx)(core_1.Space, { grow: true, height: "100%" }), bottomButtons && bottomButtons.map(b => (0, jsx_runtime_1.jsx)(core_1.IconButton, { color: "white", variant: b.highlighted ? "light" : "subtle", radius: breakpoint.isMobile ? "xl" : undefined, square: !breakpoint.isMobile, grow: true, component: "link", children: b.children }, b.id))] })));
}
exports.Nav = Nav;
