...
exports.JumpSidebar = (0, react_1.forwardRef)(function JumpSidebar(props, ref) {
    ...
    const containerStyle = {
        default: Object.assign({ width: (0, utils_1.getReactiveProp)(width, breakpoint), borderRight: `1px solid ${theme.getColorHex("black")
                + theme.getColorHex("black", "weak")}`, paddingRight: 10, position: "sticky", top: 0, overflowX: "hidden", overflowY: "auto" }, (0, utils_1.getReactiveProp)(style, breakpoint)),
        mobile: Object.assign({ width: (0, utils_1.getReactiveProp)(width, breakpoint), borderTop: `1px solid ${theme.getColorHex("black")
                + theme.getColorHex("black", "weak")}`, padding: "10px 0px 10px 0px", backgroundColor: theme.getColorHex("white"), position: "sticky", top: 0, zIndex: 999 }, (0, utils_1.getReactiveProp)(style, breakpoint))
    };
